...
<body>
  <div class="container">
    ...
    <div class="row">
      <div class="col-md-6">
        ...
        <textarea name="ce" class="form-control" id="my-editor"></textarea>
      </div>
      <div class="col-md-6">
        <h2 class="mt-4">TinyMCE</h2>
        <textarea name="tm" class="form-control" id="my-editor"></textarea>
      </div>
    </div>
    <div class="row">
      <div class="col-md-6">
  ...
  <script>
    {!! \File::get(base_path('vendor/mafftor/laravel-file-manager/public/js/stand-alone-button.js')) !!}
  </script>
  <script>
