    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1>Edit Role <a href="{{ route('roles.index') }}" class="btn btn-sm btn-primary">View Roles</a>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                        ...
                        <form action="{{ route('roles.update', $role->id) }}" method="POST" class="bg-light p-3">
                            ...
                            <div class="row">
                                ...
                                <div class="this-one col-md-4">
                                    <ul>
                                        <li>
                                            <input type="checkbox" /> Manage Journals
                                            <ul class="padding">
                                                @php
                                                    $userperms = DB::table('permissions')
                                                        ->where('column_name', 'journals')
                                                        ->get();
                                                @endphp
                                                @foreach ($userperms as $userperm)
                                                    <li>
                                ...
                                <div class="this-one col-md-4">
                                    <ul>
                                        <li>
                                            <input type="checkbox" /> Manage Vendors
                                            <ul class="padding">
                                                @php
                                                    $userperms = DB::table('permissions')
                                ...
                                <div class="this-one col-md-4">
                                    <ul>
                                        <li>
                                            <input type="checkbox" /> Manage Daily Expenses
                                            <ul class="padding">
                                                @php
                                                    $userperms = DB::table('permissions')
                                                        ->where('column_name', 'daily_expenses')
                                                        ->get();
                                                @endphp
                                                @foreach ($userperms as $userperm)
                                                    <li>
