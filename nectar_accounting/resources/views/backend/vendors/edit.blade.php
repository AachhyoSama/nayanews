  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="m-0">Edit Company Information <a href="{{ route('vendors.index') }}" class="btn btn-primary">Our Suppliers</a></h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="province" class="form-control province">
                                                    ...
                                                    @foreach ($provinces as $province)
                                                        <option value="{{ $province->id }}"{{ $province->id == $vendor->province_id ? 'selected' : '' }}>{{ $province->eng_name }}</option>
                                                    @endforeach
                                                </select>
                                                <p class="text-danger">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="district" class="form-control" id="district">
                                                    @foreach ($district_group as $district)
                                                        <option value="{{ $district->id }}"{{ $district->id == $vendor->district_id ? 'selected' : '' }}>{{ $district->dist_name }}</option>
                                                    @endforeach
                                                </select>
                                                <p class="text-danger">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="concerned_name" class="form-control" value="{{ $vendor->concerned_name }}" placeholder="Enter Concerned Person Name">
                                                <p class="text-danger">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="concerned_phone" class="form-control" value="{{ $vendor->concerned_phone }}" placeholder="Enter Concerned Person Phone">
                                                <p class="text-danger">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="email" name="concerned_email" class="form-control" value="{{ $vendor->concerned_email }}" placeholder="Enter Concerned Person Email">
                                                <p class="text-danger">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="designation" class="form-control" value="{{ $vendor->designation }}" placeholder="Enter Concerned Person Designation">
                                                <p class="text-danger">
