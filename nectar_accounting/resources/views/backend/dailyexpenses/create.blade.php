  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="m-0">Daily Expense Information <a href="{{ route('dailyexpenses.index') }}" class="btn btn-primary">Daily Expenses</a></h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
        ...
        <div class="ibox">
            <div class="row ibox-body">
                <div class="col-sm-12 col-md-12">
                    <div class="card">
                        <div class="card-body">
                            <form action="{{route('dailyexpenses.store')}}" method="POST" enctype="multipart/form-data">
                                @csrf
                                @method("POST")
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="entry_date" name="date" class="form-control datepicker" value="{{ old('date') }}" />
                                            <p class="text-danger">
                                                {{ $errors->first('date') }}
                                            </p>
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="bill_amount" class="form-control" value="{{ old('bill_amount') }}" placeholder="Enter Bill Amount">
                                            <p class="text-danger">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="paid_amount" class="form-control" value="{{ old('paid_amount') }}" placeholder="Enter Paid Amount">
                                            <p class="text-danger">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="purpose">Particulars</label>
                                            <textarea name="purpose" class="form-control" cols="30" rows="10" placeholder="Purpose of expenses" value="{{ old('purpose') }}"></textarea>
                                            <p class="text-danger">
