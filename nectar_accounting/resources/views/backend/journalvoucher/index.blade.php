  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-4">
            <div class="col-sm-8">
              <h1 class="m-0">Journal Vouchers <a href="{{ route('journals.create') }}" class="btn btn-success">Entry New Journal</a> <a href="{{ route('journals.cancelled') }}" class="btn btn-danger">Cancelled Journals</a> <a href="{{ route('journals.unapproved') }}" class="btn btn-primary">Unapproved Journals</a></h1>
            </div><!-- /.col -->
            <div class="col-sm-4">
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header text-center">
                            ...
                            <h4>For the fiscal year {{ $current_fiscal_year->fiscal_year }}</h4>
                        </div>
